    ...
    <div class="card small mb-3">
        ...
        <div class="card-body p-2">
            ...
            if(isset($_POST['nama_pelanggan']))
            {
                ...
                $tambahPel = mysqli_query($conn,"INSERT INTO pelanggan(nama_pelanggan)
            ...
            ?>
                <form method="post">
                    <div class="row">
                        ...
                        <div class="col-8 mb-2 pl-0">
                            <input type="text" class="form-control form-control-sm" name="nama_pelanggan" onchange="form.submit()" required>>
                        </div>
            ...
            <div class="row">
                ...
                <?php 
                    ...
                    $jsArrayp1 = "var nama_pelanggan = new Array();";
                ...
                <div class="col-4 mb-2 text-right pt-1 pr-1"> </div>
                <div class="col-8 mb-2 pl-0">
                    <input type="hidden" class="form-control form-control-sm bg-white" id="telepon_pelanggan" readonly>
                </div>
                <div class="col-4 text-right pt-1 pr-1"></div>
                <div class="col-8 pl-0">
                    <input type="hidden" class="form-control form-control-sm bg-white" id="alamat_pelanggan" readonly>
                </div>
...
<div class="col-lg-9" id="print">
    ...
    <div class="row print-none">
        ...
        <?php 
            ...
            $jsArray1 = "var kode_produk = new Array();";
        ...
        <div class="col-6 col-lg-2 pr-0">
            ...
            <input type="text" class="form-control form-control-sm bg-white" id="kode_produk" readonly>
        </div>
